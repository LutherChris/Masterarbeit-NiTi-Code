...
x_order_0=4; y_order_0=4; z_order_0=4; no_a0_0=False # Gitter von Iteration #4
filter_intersection_0=False; filter_tol_0=1e-3; cut_energy_0=1e-3

plot_nk_model_0=1000; plot_path_0=True; calc_path_0=False
# ---------------------------------------------------------------------------------------
...
alpha=0.3; plot_grid = True; path_grid = False # Definition des Gitters
...
filter_intersection_1=True; filter_tol_1=1e-3; cut_energy_1=None # von Iteration Nr.1

plot_nk_model_1=1000; plot_path_1 = False; calc_path_1=True
# ---------------------------------------------------------------------------------------
## weitere Plots
plot_titel = "Differenz der Bänder"
## 4D Plots
black_plot=False; plot_cut_value=5e-4; plot_thz_cut_diff=False; energy_4D = "diff"; plot_data=True
