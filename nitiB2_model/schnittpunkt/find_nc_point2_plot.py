...
#k0=(0.303, 0.303, 0.303); p=0.0002; n=11; grid_type="regular"; datlabel="punkt2_find_01"; rotation=False

# Gitter Nr 2 ; Punkteabstand 0.000008
#k0=(0.303, 0.303, 0.303); p=0.00004; n=11; grid_type="regular"; datlabel="punkt2_find_02"; rotation=False

# Gitter Nr 3 ; Punkteabstand 0.0000016
# ändere auf Conjugate-Gradient-Verfahren wegen Fehler "S matrix not positive definite"
# diagonalization = 'cg'
#k0=(0.302992, 0.302992, 0.302992); p=0.000008; n=11; grid_type="regular"; datlabel="punkt2_find_03"; rotation=False

# Gitter Nr 4 ; Punkteabstand 3.2e-7
# diagonalization = 'cg'
#k0=(0.3029936, 0.3029936, 0.3029936); p=0.0000016; n=11; grid_type="regular"; datlabel="punkt2_find_04"; rotation=False

# Finales Gitter Nr 5 (Kontrollgitter)
#k0=(0.30299328, 0.30299328, 0.30299328); p=0.0000016; n=11; grid_type="regular"; datlabel="punkt2_find_05"; rotation=False

# Finales Ergebnis: Energien in Größenordnung e-7
# (0.30299328, 0.30299328, 0.30299328)

# =======================================================================================
# Berechnungen am Schnittpunkt 2B, Gitterdefinition

# Gitter Nr 0 ; Punkteabstand 0.0004
#k0=(0.314, 0.314, 0.280); p=0.002; n=11; grid_type="regular"; datlabel="punkt2B_find_00"; rotation=False

# Gitter Nr 1 ; Punkteabstand 0.0002
#k0=(0.3136, 0.3136, 0.280); p=0.001; n=11; grid_type="regular"; datlabel="punkt2B_find_01"; rotation=False

# Gitter Nr 2 ; Punkteabstand 0.00004
#k0=(0.3138, 0.3138, 0.2794); p=0.0002; n=11; grid_type="regular"; datlabel="punkt2B_find_02"; rotation=False

# Gitter Nr 3 ; Punkteabstand 0.000008
#k0=(0.31376, 0.31376, 0.27956); p=0.00004; n=11; grid_type="regular"; datlabel="punkt2B_find_03"; rotation=False

# Gitter Nr 4 ; Punkteabstand 0.000008
#k0=(0.313776, 0.313776, 0.27952); p=0.00004; n=11; grid_type="regular"; datlabel="punkt2B_find_04"; rotation=False

# Gitter Nr 5 ; Punkteabstand 0.0000016
#k0=(0.313776, 0.313776, 0.27952); p=0.000008; n=11; grid_type="regular"; datlabel="punkt2B_find_05"; rotation=False

# Gitter Nr 6 ; Punkteabstand 3.2e-7
#k0=(0.3137744, 0.3137744, 0.2795232); p=0.0000016; n=11; grid_type="regular"; datlabel="punkt2B_find_06"; rotation=False

# Finales Gitter Nr 7 (Kontrollgitter)
k0=(0.31377504, 0.31377504, 0.2795216); p=0.0000016; n=11; grid_type="regular"; datlabel="punkt2B_find_07"; rotation=False

# Finales Ergebnis: Energien in Größenordnung e-7
# (0.31377536, 0.31377536, 0.27952064)
